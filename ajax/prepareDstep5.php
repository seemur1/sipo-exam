...
//заказчик
echo"<table border='0'  >";
 echo"<tr><td class='tHeader'>№ ТЗ спецификации РФ</td><td class='tText'><input type='text' name='p5'></td></tr>";
...
echo"</td></tr>"; 
echo"</table>";
echo"<input type='hidden' name='doPrepareDstep5' value='1'><input type='hidden' name='zid' value='$f[id]'><br><br><input style='font-size:24px' onclick='sendDstep3()' type='button' value='Сохранить'></form>";
echo"</div>";
?>