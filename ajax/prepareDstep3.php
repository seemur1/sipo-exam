...
echo"<br><div align='center' style= 'width: 780px; height: 500px; background-color: white; border-radius: 10px;overflow-x:hidden'>";
 ...
 echo"<br><div style='font-size:22px'>Подготовка ТЗ спецификации<hr></div>";
...
echo"</td></tr>"; 
echo"</table>";
echo"<input type='hidden' name='doPrepareDstep3' value='1'><input type='hidden' name='zid' value='$f[id]'><br><br><input style='font-size:24px' onclick='sendDstep3()' type='button' value='Сохранить'></form>";
echo"</div>";
?>